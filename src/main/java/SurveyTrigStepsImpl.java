...
public class SurveyTrigStepsImpl {
    ...
    public void callingAPI() {
        RestAssured.given().get("http://172.16.28.71:8107/v1.0/survey/metrics/");
    }

    public int eventTrigger(String event) {
        RestAssured.given().when().get("http://172.16.28.71:8107/v1.0/survey/metrics/scheduler?event=" + event).then().statusCode(200);

        Response response = doGetRequest("http://172.16.28.71:8107/v1.0/survey/metrics/scheduler?event=" + event);
